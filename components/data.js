...
export const VIP_QUOTES = (en) => [
  ...
  { name: "Mustafa Suleyman", title: en ? "CEO, Microsoft AI" : "CEO, Microsoft AI", initials: "MS", gradient: "linear-gradient(135deg, #2563eb, #f59e0b)", photo: null, quote: en ? "AI is the most consequential technology since fire. We need new institutions, not just new technology." : "AI es la tecnología más consecuente desde el fuego. Necesitamos nuevas instituciones, no solo nueva tecnología.", src: "https://www.microsoft.com/en-us/ai" },
  { name: "Alicia Bárcena", title: en ? "ECLAC Executive Secretary (2008-2022)" : "Secretaria Ejecutiva CEPAL (2008-2022)", initials: "AB", gradient: "linear-gradient(135deg, #2563eb, #8b5cf6)", photo: null, quote: en ? "Latin America cannot afford to be a passive consumer of AI. The region must develop sovereign capabilities or risk permanent digital dependency." : "América Latina no puede permitirse ser consumidora pasiva de AI. La región debe desarrollar capacidades soberanas o arriesgar dependencia digital permanente.", src: "https://www.cepal.org/" },
  { name: "Kai-Fu Lee", title: en ? "CEO Sinovation, AI Author" : "CEO Sinovation, Autor AI", initials: "KL", gradient: "linear-gradient(135deg, #ef4444, #f97316)", photo: null, quote: en ? "AI will displace 40% of jobs in the next 15 years. Countries that prepare their workforce now will thrive; those that don't will suffer." : "AI desplazará el 40% de los empleos en los próximos 15 años. Los países que preparen su fuerza laboral ahora prosperarán; los que no, sufrirán.", src: "https://www.sinovationventures.com/" }
];
