          ...
          <Grid cols="repeat(auto-fit, minmax(150px, 1fr))" gap={10}>
            {[
              ...
              { criterion: en ? "Measurable Impact" : "Impacto Medible", icon: "chart", color: "#10b981",
                ours: en ? `20 countries, 25+ sources, ${OBSERVATORY_IMPACT.liveApis} live APIs, 10 algorithms, ${OBSERVATORY_IMPACT.analysisViews} analysis views` : `20 países, 25+ fuentes, ${OBSERVATORY_IMPACT.liveApis} APIs en vivo, 10 algoritmos, ${OBSERVATORY_IMPACT.analysisViews} vistas de análisis` },
          ...
          <Grid cols="repeat(auto-fit, minmax(200px, 1fr))" gap={12}>
            {[
              ...
              { title: en ? "Real-Time Data" : "Datos en Tiempo Real", color: t.gn,
                desc: en ? "3 live APIs (World Bank, GDELT, Exchange Rate) providing current-day intelligence" : "3 APIs en vivo (Banco Mundial, GDELT, Tipo Cambio) proporcionando inteligencia del día" },
