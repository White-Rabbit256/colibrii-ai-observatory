...
export const STORAGE_SITES = [
  ...
  /* ── South & East Asia ── */
  { id: "greenko-phs-bess",  lat: 15.430,  lng: 77.930,   name: { es: "Greenko Pinnapuram (PHS+BESS)", en: "Greenko Pinnapuram (PHS+BESS)" }, country: { es: "India",    en: "India"      }, mw: 1200, mwh: 10800, chem: "phs",     status: "con", comYear: 2025, s: "iea_storage", lic: "cc_by_4" },
