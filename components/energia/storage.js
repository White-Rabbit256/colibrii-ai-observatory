...
export const STORAGE_SITES = [
  ...
  { id: "fengning-phs",      lat: 41.209,  lng: 116.648,  name: { es: "Fengning (PHS)",               en: "Fengning (PHS)" },               country: { es: "China",     en: "China"      }, mw: 3600, mwh: 40000, chem: "phs",     status: "op",  comYear: 2024, s: "iea_storage", lic: "cc_by_4" },
  { id: "huizhou-phs",       lat: 23.095,  lng: 114.415,  name: { es: "Huizhou (PHS)",                en: "Huizhou (PHS)" },                country: { es: "China",     en: "China"      }, mw: 2448, mwh: 21000, chem: "phs",     status: "op",  comYear: 2011, s: "iea_storage", lic: "cc_by_4" },
  { id: "dalian-vrfb",       lat: 38.914,  lng: 121.615,  name: { es: "Dalian (flujo de vanadio)",    en: "Dalian (vanadium flow)" },       country: { es: "China",     en: "China"      }, mw: 200,  mwh: 800,   chem: "flow",    status: "op",  comYear: 2022, s: "iea_storage", lic: "cc_by_4" },
  { id: "ningxia-ynk",       lat: 38.487,  lng: 106.231,  name: { es: "Yinchuan-Ningxia",             en: "Yinchuan-Ningxia" },             country: { es: "China",     en: "China"      }, mw: 200,  mwh: 800,   chem: "li",      status: "op",  comYear: 2024, s: "iea_storage", lic: "cc_by_4" },
  ...
  { id: "dinorwig-phs",      lat: 53.118,  lng: -4.114,   name: { es: "Dinorwig (PHS)",               en: "Dinorwig (PHS)" },               country: { es: "Reino Unido", en: "United Kingdom" }, mw: 1728, mwh: 9100, chem: "phs",     status: "op",  comYear: 1984, s: "iea_storage", lic: "cc_by_4" },

  /* ── Europe ── */
  { id: "andasol-csp",       lat: 37.228,  lng: -3.070,   name: { es: "Andasol (sales fundidas CSP)", en: "Andasol (molten-salt CSP)" },    country: { es: "España",    en: "Spain"      }, mw: 150,  mwh: 1100,  chem: "thermal", status: "op",  comYear: 2011, s: "iea_storage", lic: "cc_by_4" },
  { id: "kruonis-phs",       lat: 54.771,  lng: 24.458,   name: { es: "Kruonis (PHS)",                en: "Kruonis (PHS)" },                country: { es: "Lituania", en: "Lithuania" }, mw: 900,  mwh: 11500, chem: "phs",     status: "op",  comYear: 1992, s: "iea_storage", lic: "cc_by_4" },
  ...
  { id: "coya-bess",         lat: -23.060, lng: -68.450,  name: { es: "Coya / TAP BESS (Engie/AES)",  en: "Coya / TAP BESS (Engie/AES)" },  country: { es: "Chile",     en: "Chile"      }, mw: 220,  mwh: 1100,  chem: "li",      status: "op",  comYear: 2024, s: "iea_storage", lic: "cc_by_4" },
  { id: "puerto-penasco",    lat: 31.316,  lng: -113.540, name: { es: "Puerto Peñasco híbrido PV+BESS", en: "Puerto Peñasco hybrid PV+BESS" },country: { es: "México",    en: "Mexico"     }, mw: 156,  mwh: 250,   chem: "li",      status: "op",  comYear: 2024, s: "iea_storage", lic: "cc_by_4" },
  { id: "furnas-pilot",      lat: -22.450, lng: -45.120,  name: { es: "Furnas BESS (piloto)",         en: "Furnas BESS (pilot)" },          country: { es: "Brasil",    en: "Brazil"     }, mw: 30,   mwh: 60,    chem: "li",      status: "op",  comYear: 2025, s: "iea_storage", lic: "cc_by_4" },

  /* ── South & East Asia ── */
  { id: "greenko-phs-bess",  lat: 17.050,  lng: 78.500,   name: { es: "Greenko Pinnapuram (PHS+BESS)", en: "Greenko Pinnapuram (PHS+BESS)" }, country: { es: "India",    en: "India"      }, mw: 1200, mwh: 10800, chem: "phs",     status: "con", comYear: 2025, s: "iea_storage", lic: "cc_by_4" },
  { id: "shin-incheon",      lat: 37.469,  lng: 126.624,  name: { es: "Shin-Incheon BESS",            en: "Shin-Incheon BESS" },            country: { es: "Corea del Sur", en: "South Korea" }, mw: 156, mwh: 318, chem: "li",      status: "op",  comYear: 2018, s: "iea_storage", lic: "cc_by_4" },
  { id: "buzen-nas",         lat: 33.610,  lng: 131.090,  name: { es: "Buzen NaS BESS",               en: "Buzen NaS BESS" },               country: { es: "Japón",     en: "Japan"      }, mw: 50,   mwh: 300,   chem: "other",   status: "op",  comYear: 2016, s: "iea_storage", lic: "cc_by_4" },
  { id: "magat-snap",        lat: 16.880,  lng: 121.410,  name: { es: "Magat híbrido + SNAp BESS",    en: "Magat hybrid + SNAp BESS" },     country: { es: "Filipinas",en: "Philippines" }, mw: 200,  mwh: 400,   chem: "li",      status: "op",  comYear: 2024, s: "iea_storage", lic: "cc_by_4" },

  /* ── Middle East / Africa ── */
  { id: "bisha-pif",         lat: 19.974,  lng: 42.609,   name: { es: "Bisha (PIF)",                  en: "Bisha (PIF)" },                  country: { es: "Arabia Saudita", en: "Saudi Arabia" }, mw: 2000, mwh: 8000, chem: "li",  status: "con", comYear: 2025, s: "iea_storage", lic: "cc_by_4" },
  { id: "al-dhafra-bess",    lat: 23.624,  lng: 54.422,   name: { es: "Al Dhafra BESS adyacente",     en: "Al Dhafra adj. BESS" },          country: { es: "EAU",       en: "UAE"        }, mw: 600,  mwh: 2400,  chem: "li",      status: "op",  comYear: 2025, s: "iea_storage", lic: "cc_by_4" },
  { id: "kenhardt-scatec",   lat: -29.345, lng: 21.150,   name: { es: "Kenhardt PV+BESS (Scatec)",    en: "Kenhardt PV+BESS (Scatec)" },    country: { es: "Sudáfrica", en: "South Africa" }, mw: 540, mwh: 1140, chem: "li",     status: "op",  comYear: 2024, s: "iea_storage", lic: "cc_by_4" },

  /* ── Canada ── */
  { id: "oneida-six-nations",lat: 43.085,  lng: -79.771,  name: { es: "Oneida BESS (Ontario)",        en: "Oneida BESS (Ontario)" },        country: { es: "Canadá",   en: "Canada"     }, mw: 250,  mwh: 1000,  chem: "li",      status: "op",  comYear: 2025, s: "iea_storage", lic: "cc_by_4" },
];
