...
export const STORAGE_SITES = [
  ...
  { id: "terna-brindisi",    lat: 40.450,  lng: 16.670,   name: { es: "Brindisi BESS (Terna)",        en: "Brindisi BESS (Terna)" },        country: { es: "Italia",   en: "Italy"     }, mw: 250,  mwh: 1000,  chem: "li",      status: "op",  comYear: 2024, s: "iea_storage", lic: "iea_terms" },
